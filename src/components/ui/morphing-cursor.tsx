...
export function MagneticText({ text = "CREATIVE", hoverText = "EXPLORE", className }: MagneticTextProps) {
  ...
  return (
    <div
      ...
      className={cn("relative inline-flex items-center justify-center select-none cursor-none", className)}
    >
      {/* Base text layer - original text */}
      <span className="font-bold tracking-tighter text-foreground tracking-wide">{text}</span>
      ...
      >
        <div
          ...
          style={{
            ...
            top: '50%',
            left: '50%',
            marginLeft: `-${containerSize.width / 2 - 370}px`,
            marginTop: `-${containerSize.height / 2 - 40}px`,
            willChange: "transform",
          }}
        >
          <span className="font-bold tracking-tighter text-background whitespace-nowrap tracking-wide">
            {hoverText}
          </span>
        </div>
      </div>
